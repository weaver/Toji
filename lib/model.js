...
Model.extend({
  validatesPresenceOf: function(names) {
    return this.addValidation(names, function(name) {
      this.modifyField(name, function(field) {
  ...
  addValidation: function(names, add) {
    var self = this;
...
NullableField.include({
  ...
  dumpJSON: function(obj) {
    ...
    if (type.box && U.isPlainObject(obj)) {
      ...
      return this.boxAs(primary, obj);
    }

    return Avro.Field.fn.dumpJSON.call(this, obj);
  },
