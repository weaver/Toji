...
Model.extend({
  ...
  //   Avro.RecordType.eachField.call(this, obj, fn);
  //   for (var key in this.__virtual__)
  //     fn(obj[key], key, this.__virtual__[key]);
  //   return this;
  // },
  ...
  defineVirtual: function(name, schema) {
    // var f = this.FieldType.compile(this, this.__reg__, schema);
    // if (f.name in names)
    //   throw new Avro.Invalid(this, 'duplicate field', field);
    // this.__virtual__[f.name] = f;
    this.__virtual__[name] = { name: name, schema: schema };
    return this;
  }
});
