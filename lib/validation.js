...
Model.Model.extend({
  validatesPresenceOf: function(names, message) {
    var validator = !message ? validatePresence : function(val, field, obj) {
      return validatePresence(val, field, obj, message);
    };
...
function validatePresence(val, field, obj, message) {
...
Model.Model.extend({
  ...
  dumpValid: function(obj) {
    if (obj.isValid(true))
      return Avro.dumpJSON(obj);
    throw new Avro.Invalid(this, firstErrorMessage(obj));
  }
});
