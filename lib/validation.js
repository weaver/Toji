...
Model.Model.extend({
  ...
  validatesUniquenessOf: function(names, message, valueFn) {
    var self = this;

    return this
      .validatesNotNull(names)
      .validatesEach(names, function(name) {
        self.addUniqueIndex(name, message, valueFn);
      });
  }
});
...
Model.Model.extend({
  getUniqueIndex: function(name) {
    return this.indicies.getUnique(name);
  },

  addUniqueIndex: function(name, message, valueFn) {
    this.indicies.addUnique(name, message, valueFn);
    return this;
  },

  getIndex: function(name) {
    return this.indicies.getIndex(name);
  },

  addIndex: function(name, message, valueFn) {
    this.indicies.addIndex(name, message, valueFn);
    return this;
  }
});
